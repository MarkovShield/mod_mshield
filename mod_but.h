...
#define MOD_BUT_SESSION_COUNT		100	/* Default number of mod_but sessions (SHM) */
#endif
#ifndef MOD_BUT_COOKIESTORE_COUNT
#define MOD_BUT_COOKIESTORE_COUNT	200	/* Default cookiestore size (SHM) */
#endif


#define MOD_BUT_HASH_LENGTH		100
